...
export default class EventManager {
    ...
    // conexão estabilizada, manda evento informando espera de menssagens
    ...
    getEvents() {
        const functions = Reflect.ownKeys(EventManager.prototype)
            .filter(fn => fn !== 'constructor')  // filtro todos os constructors, não interessam aqui
            .map(name => [name, this[name].bind(this)])  // pega as instâncias e prepara para o Map(), bind para continuar os contextos
